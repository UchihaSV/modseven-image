...
namespace Modseven\Image\Driver;
...
class GD extends Image {
	...
	protected static array $availableFunctions = array();
	...
	public static function check()
	{
		...
		{
			self::$available_functions[$function] = function_exists($function);
		}
	...
	{
		if (empty(self::$availableFunctions[self::IMAGEROTATE]))
		{
	...
	{
		if (empty(self::$availableFunctions[self::IMAGECONVOLUTION]))
		{
			throw new Exception('This method requires :function, which is only available in the bundled version of GD',
	...
	{
		if (empty(self::$availableFunctions[self::IMAGEFILTER]))
		{
			throw new Exception('This method requires :function, which is only available in the bundled version of GD',
     ...
     *
     * @param Image $watermark watermarking Image
     * @param integer $offset_x offset from the left
     * @param integer $offset_y offset from the top
     ...
     * @throws Exception
     */
	protected function _do_watermark(Image $watermark, int $offset_x, int $offset_y, int $opacity)
	{
		if (empty(self::$availableFunctions[self::IMAGELAYEREFFECT]))
		{
			throw new Exception('This method requires :function, which is only available in the bundled version of GD',
